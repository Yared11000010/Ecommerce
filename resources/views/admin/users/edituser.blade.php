    ...
    <section class="section col-md-6" >
        <div class="card" >
            ...
            <div class="card-body pt-3">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href=""><i class="fa fa-list mr-2"></i>Edit User</a>
                </li>
                ...
                <form id="loginForm" action="{{ route('update_user') }}" method="POST"  enctype="multipart/form-data" >
                    @csrf
                    @method('PUT')
                    ...
                    <div class="col-md-8 pt-3">
                        ...
                        <input type="text" class="form-control" id="city" value="{{ $users->city }}"  name="city">
                        @error('city')
                        <small class=" text-danger">{{ $message }}</small>
                        @enderror
                    </div>
                    <div class="col-md-8 pt-3">
                        ...
                        <input type="text" class="form-control" id="state" value="{{ $users->state }}"  name="state">
                        @error('state')
                        <small class=" text-danger">{{ $message }}</small>
                        @enderror
                    </div>
                    <div class="col-md-8 pt-3">
                        ...
                        <input type="text" class="form-control" id="pincode"  value="{{ $users->pincode }}" name="pincode">
                        @error('pincode')
                        <small class=" text-danger">{{ $message }}</small>
                        @enderror
                    </div>
                    <div class="col-md-8 pt-3">
                        ...
                        <input type="text" class="form-control" id="country"value="{{ $users->country }}"  name="country">
                        @error('country')
                        <small class=" text-danger">{{ $message }}</small>
                        @enderror
                    </div>
