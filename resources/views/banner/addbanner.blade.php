      ...
      <div class="card-body pt-3">
                     ...
                     <ul class="nav nav-tabs pb-4 align-items-end card-header-tabs w-100">
                        <li class="nav-item border-none">
                           <a class="nav-link active bg-light" href=""><i class=" fas fa-plus"></i>Add Banner</a>
                         </li>
                     ...
                     <form class="row g-3" action="{{ route('banners') }}" method="POST" enctype="multipart/form-data" >
                        @csrf
                        <div class="col-md-6">
